...
export default function Footer() {
  return (
    <footer
      className="bg-dark-green mt-10 border-t-2 border-emerald-700 border-opacity-70"
      aria-labelledby="footer-heading"
    >
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-20 opacity-100">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <Link href='/' className="space-x-3 sm:flex text-2xl rounded-md 
                font-semibold cursor-pointer ease-linear duration-300">
                <p className="mt-3 hidden md:block text-cream hover:text-gray-100">Homestead Careers</p>
            </Link>
        ...
        <div className="mt-8 md:mt-12 border-t border-cream pt-8 md:flex md:items-center md:justify-between">
          <p className="mt-8 text-md leading-5 text-neutral-300 md:order-1 md:mt-0">
            &copy; {new Date().getFullYear()} Homestead Careers. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
